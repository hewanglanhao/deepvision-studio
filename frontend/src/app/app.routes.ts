...
export const routes: Routes = [
  ...
  {
    path: 'mode-g',
    loadComponent: () => import('@modes/mode-g/mode-g-page.component')
      .then(m => m.ModeGPageComponent)
  },
  {
    path: 'mode-h',
    loadComponent: () => import('@modes/mode-h/mode-h-page.component')
      .then(m => m.ModeHPageComponent)
  },
  {
    path: 'ai-museum',

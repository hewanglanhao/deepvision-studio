...
import { ModeDStateService, type SubStep } from '../../services/mode-d-state.service';
...
@Component({
  selector: 'app-mode-d-overview',
  imports: [CommonModule],
  templateUrl: './mode-d-overview.component.html',
  styleUrl: './mode-d-overview.component.css',
})
export class ModeDOverviewComponent {
